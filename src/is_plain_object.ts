...
const TYPE_RE_ = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/;
...
export function hasOwn(value: any, key: string) {
  return Object.prototype.hasOwnProperty.call(Object(value), key); // TODO: how does the object help?
};
